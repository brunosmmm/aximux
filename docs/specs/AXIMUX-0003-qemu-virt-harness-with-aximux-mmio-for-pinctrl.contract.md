# Consuming this spec — AXIMUX-0003
...
- The wt author can later run `wt spec pull-status AXIMUX-0003` to mirror this file's
  `status` back into their outbox — optional, not automatic.
- Do **not** run `wt spec generate` on this outbound id.

## Provenance

- Source: outbound spec `AXIMUX-0003` (project `Aximux`), `wt`'s canonical copy at
  `/home/bruno/.local/share/wt/outbox/Aximux/AXIMUX-0003-qemu-virt-harness-with-aximux-mmio-for-pinctrl.md`.
- Exported: 2026-09-03 16:37:48
- Portable spec: `AXIMUX-0003-qemu-virt-harness-with-aximux-mmio-for-pinctrl.md`
- Content hash: `f7eefc2810e21ac2`
