# Consuming this spec — AXIMUX-0001
...
- The wt author can later run `wt spec pull-status AXIMUX-0001` to mirror this file's
  `status` back into their outbox — optional, not automatic.
- Do **not** run `wt spec generate` on this outbound id.

## Provenance

- Source: outbound spec `AXIMUX-0001` (project `Aximux`), `wt`'s canonical copy at
  `/home/bruno/.local/share/wt/outbox/Aximux/AXIMUX-0001-bring-aximux-cocotb-coverage-up-to-a-reliable.md`.
- Exported: 2026-09-02 16:06:09
- Portable spec: `AXIMUX-0001-bring-aximux-cocotb-coverage-up-to-a-reliable.md`
- Content hash: `faf1c6736c696891`
