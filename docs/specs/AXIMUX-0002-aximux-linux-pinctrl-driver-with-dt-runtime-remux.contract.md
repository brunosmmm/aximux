# Consuming this spec — AXIMUX-0002
...
- The wt author can later run `wt spec pull-status AXIMUX-0002` to mirror this file's
  `status` back into their outbox — optional, not automatic.
- Do **not** run `wt spec generate` on this outbound id.

## Provenance

- Source: outbound spec `AXIMUX-0002` (project `Aximux`), `wt`'s canonical copy at
  `/home/bruno/.local/share/wt/outbox/Aximux/AXIMUX-0002-aximux-linux-pinctrl-driver-with-dt-runtime-remux.md`.
- Exported: 2026-09-02 16:48:04
- Portable spec: `AXIMUX-0002-aximux-linux-pinctrl-driver-with-dt-runtime-remux.md`
- Content hash: `ece37812d6a558a6`
